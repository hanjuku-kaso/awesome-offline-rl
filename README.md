...
- [BAIL: Best-Action Imitation Learning for Batch Deep Reinforcement Learning](https://arxiv.org/abs/1910.12179) by Xinyue Chen, Zijian Zhou, Zheng Wang, Che Wang, Yanqiu Wu and Keith Ross, NeurIPS2020.
- [MOPO: Model-based Offline Policy Optimization](https://papers.nips.cc/paper/2020/hash/a322852ce0df73e204b7e67cbbef0d0a-Abstract.html) by Tianhe Yu, Garrett Thomas, Lantao Yu, Stefano Ermon, James Y. Zou, Sergey Levine, Chelsea Finn and Tengyu Ma, NeurIPS2020.
...
- [Off-Policy Deep Reinforcement Learning without Exploration](https://arxiv.org/abs/1812.02900) by Scott Fujimoto, David Meger and Doina Precup, ICML2019.
...
- [Near Real-World Benchmarks for Offline Reinforcement Learning](https://arxiv.org/abs/2102.00714) by Rongjun Qin, Songyi Gao, Xingyuan Zhang, Zhen Xu, Shengkai Huang, Zewen Li, Weinan Zhang and Yang Yu, arXiv2021. [[website](http://polixir.ai/research/newrl)]
